...
//filter
const fifhun = inventors.filter(fifteen => (fifteen.year >= 1500 && fifteen.year < 1600));
console.table(fifhun);
...
//sort by alphabet
const alphs = people.sort((last, next) => {
    const [xlast,xfirst] = last.split(', ');
    const [ylast,yfirst] = next.split(', ');
